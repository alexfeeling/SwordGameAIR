package com.alex.skill
{
	...
	public class SkillShow extends BaseUnit
	{
		...
		override protected function createUI():void
		{
			...
			body.graphics.drawRect(-WorldMap.GRID_WIDTH / 2, -WorldMap.GRID_HEIGHT, WorldMap.GRID_WIDTH, WorldMap.GRID_HEIGHT);
		...
		///碰撞
		override public function collide(unit:IPhysics, moveDir:int):void
		{
			if (unit == null) return;
