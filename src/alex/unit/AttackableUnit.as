package alex.unit
{
	...
	import alex.core.unit.IAttributeUnit;
	import alex.core.unit.IWorldUnit;
	import alex.core.util.Cube;
	import alex.core.world.World;
	import alex.skill.SkillData;
	...
	public class AttackableUnit extends BaseUnit implements IAttackable, IAttributeUnit
	{
		...
		/* INTERFACE alex.display.IAttackable */
		...
		/* INTERFACE alex.display.IAttribute */
