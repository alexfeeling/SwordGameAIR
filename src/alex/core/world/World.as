package alex.core.world
{
	...
	public class World extends Sprite implements IAnimation, IOrderExecutor
	{
		...
		private function loadMapBlock(blockX:int, blockY:int):void
		{
			...
			//if (this._allMapBlockDic[blockX] != null && this._allMapBlockDic[blockX][blockY] != null)
			//{
				//该位置已经有对象，不加载
				//return;
			//}
		...
		public function getAroudItemsByMove(vDir:int, vPosition:Position):Array
		{
			...
			switch (vDir)
			{
				case MoveDirection.X_LEFT: 
					return [this.getGridItemDic(vPosition.gridX - 1, vPosition.gridY), this.getGridItemDic(vPosition.gridX - 1, vPosition.gridY - 1), this.getGridItemDic(vPosition.gridX - 1, vPosition.gridY + 1), this.getGridItemDic(vPosition.gridX, vPosition.gridY), this.getGridItemDic(vPosition.gridX, vPosition.gridY - 1), this.getGridItemDic(vPosition.gridX, vPosition.gridY + 1)];
				case MoveDirection.X_RIGHT: 
					return [this.getGridItemDic(vPosition.gridX + 1, vPosition.gridY), this.getGridItemDic(vPosition.gridX + 1, vPosition.gridY - 1), this.getGridItemDic(vPosition.gridX + 1, vPosition.gridY + 1), this.getGridItemDic(vPosition.gridX, vPosition.gridY), this.getGridItemDic(vPosition.gridX, vPosition.gridY - 1), this.getGridItemDic(vPosition.gridX, vPosition.gridY + 1)];
				case MoveDirection.Y_UP: 
					return [this.getGridItemDic(vPosition.gridX, vPosition.gridY - 1), this.getGridItemDic(vPosition.gridX - 1, vPosition.gridY - 1), this.getGridItemDic(vPosition.gridX + 1, vPosition.gridY - 1), this.getGridItemDic(vPosition.gridX, vPosition.gridY), this.getGridItemDic(vPosition.gridX - 1, vPosition.gridY), this.getGridItemDic(vPosition.gridX + 1, vPosition.gridY)];
		...
		{
			return [this.getGridItemDic(vPosition.gridX, vPosition.gridY - 1), this.getGridItemDic(vPosition.gridX, vPosition.gridY), this.getGridItemDic(vPosition.gridX, vPosition.gridY + 1), this.getGridItemDic(vPosition.gridX - 1, vPosition.gridY - 1), this.getGridItemDic(vPosition.gridX - 1, vPosition.gridY), this.getGridItemDic(vPosition.gridX - 1, vPosition.gridY + 1), this.getGridItemDic(vPosition.gridX + 1, vPosition.gridY - 1), this.getGridItemDic(vPosition.gridX + 1, vPosition.gridY), this.getGridItemDic(vPosition.gridX + 1, vPosition.gridY + 1)];
		}
		...
		/* INTERFACE alex.core.animation.IAnimation */
